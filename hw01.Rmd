...
```{r}
hist(means.5[,2], col=rgb(0,0,1,0.5), xlim=c(7,11),main="Distribution of Means of Means", xlab="Mean")

hist(means.10[,2], col=rgb(0,1,0,0.5), xlab="Mean", add=T)

legend("topleft", c("Sample(5)","Sample(10)"),col=c(rgb(0,0,1,0.5),rgb(0,1,0,0.5)), lwd=10)
box() #decorative box around data
mtext("With fewer samples, hard to note anything.",line=0.5)


hist(means.10.500[,2], col=rgb(0,0,1,0.5), main="Distribution of Means of Means", xlab="Mean")

hist(means.5.500[,2], col=rgb(0,1,0,0.5), xlab="Mean", add=T)

legend("topright", c("Sample(5)","Sample(10)"),col=c(rgb(0,0,1,0.5),rgb(0,1,0,0.5)), lwd=10)
box() #decorative box around data
mtext("With more samples, a normal curve with median 9.5 is noticeable.",line=0.5)
