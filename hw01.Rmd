...
abline(h=1.1)
abline(v=0.73)
mtext("Best Estimate: x=0.7,3 y=1.1")
...
```{r}
means.10.1000 = takeSamples(data,seq(1,1000,10),sampleSize=10)
...
```{r}
hist(means.5[,2], col=rgb(0,0,1,0.5), xlim=c(7,11),main="Distribution of Means of Means (Samples of 5)", xlab="Mean")

hist(means.10[,2], col=rgb(1,0,0,0.5), main="Distribution of Mean of Means (Samples of 10)", xlab="Mean", add=T)

legend("topleft", c("Sample(5)","Sample(10)"),col=c(rgb(0,0,1,0.5),rgb(1,0,0,0.5)), lwd=10)
box() #decorative box around data
mtext("With fewer samples, hard to note anything.")


hist(means.5.1000[,2], col=rgb(0,0,1,0.5), main="Distribution of Means of Means (Samples of 5)", xlab="Mean")

hist(means.10.1000[,2], col=rgb(1,0,0,0.5), main="Distribution of Mean of Means (Samples of 10)", xlab="Mean", add=T)

legend("topright", c("Sample(5)","Sample(10)"),col=c(rgb(0,0,1,0.5),rgb(1,0,0,0.5)), lwd=10)
box() #decorative box around data
