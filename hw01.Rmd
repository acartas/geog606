...
means.5 = takeSamples(data,c(3,5,10,20,50),sampleSize=5); allMeans
```
...
lines(rnorm(data),means.5,col=rgb(0,0,1,0.5))
...
#Repeat with samples up to size 1000 
hist(means.5.1000, col=rgb(0,0,1,0.5), main="Distribution of Means of Means", xlab="Mean")
hist(means.10.1000, col=rgb(0,1,0,0.5), add=T)
legend("topright", c("Sample(5)","Sample(10)"),col=c(rgb(0,0,1,0.5),rgb(0,1,0,0.5)), lwd=10)
box() #decorative box around data
